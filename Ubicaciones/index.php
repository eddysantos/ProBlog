    ...
    <div class="right-aside float-right">
      <div class="card">
        <div class="card-header">
          <h6 class="m-0">Información General <span class="float-right" role="button" btn-type="collapse" data-target="#infoGeneral"><i class="fa fa-chevron-up"></i></span></h6>
        </div>
      ...
      <div class="card">
        <div class="card-header">
          <h6 class="m-0" id="header2Detalles">
            <i class="fa fa-chevron-left entradasChevron pull-left" style="display: none;" role="button"></i>
            <span id="headerValue">Entradas</span>
            <span class="float-right" role="button" btn-type="collapse" data-target="#infoEntradasFacturas"><i class="fa fa-chevron-up"></i></span>
          </h6>
        </div>
        <div id="infoEntradasFacturas">
          <div class="card-block p-0" id="refDetalleEntradas">
